...
namespace Customer.WebApi.Controllers.V1
{
    ...
    public sealed class RegisterController : ControllerPublic
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var response = await _customerService.RegisterAsync(request, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            var response = await _customerService.RegisterBulkAsync(request, cancellationToken);

            return CreatedAtAction(nameof(RegisterBulk), response);
        }
    }
}
